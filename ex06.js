/*
Welcome back to Codeville! The citizens of Codeville seem pleased with all the upgrades 
your administration has been making to the local infrastructure, and they want more! 
...
and monitor which ones are available. Every time a vehicle enters the parking lot, 
the system directs them to an available spot for their particular vehicle type, 
...
// forEachを使う
  // if文で一配列ずつupperCaseがVehicleの最初の大文字と一致するかを確認
  // includesでupper-case確認する
  // 一つ目のそれを見つけた時点で、カラム[i]の番号と列[i]の番号を返す
  // 
  //

const whereCanIPark = function (spots, vehicle) {
  let availablePark = spots.map((spot, index) => {
    if (vehicle !== null) {
